...
//where T //: IIdentifiable<TKey>
{
	...
	public async Task Should_11_add_and_read_two_objects()
	{
		...
		var item2 = new ComponentAddedEvent
		{
			...
			TargetTypeId = new Guid("C0DE0000-0000-8000-9041-000000000000"),
		};
...
public class EventsJsonlStorageTests : JsonAppendStorageTests<Event, Guid>
{
	...
	public async Task Should_store_polimorfic_as_jsonl()
	{
		...
		// semantic class. The root-component *type* is 9042-…000 (family 0 code 42, all-zero node) and its
		// instance is 9001-…103 (family 0 code 01).
		var ev = new ComponentAddedEvent
		{
			...
			TargetTypeId    = new Guid("C0DE0000-0000-8000-9042-000000000000"),
			ComponentTypeId = new Guid("C0DE0000-0000-8000-9042-000000000000"),
...
{{ev.EventId.ToString("N")}}§{"_t":"ComponentAddedEvent","ComponentTypeId":"{{ev.ComponentTypeId}}","ComponentId":"{{ev.ComponentId}}","TargetId":"{{ev.TargetId}}","TargetTypeId":"{{ev.TargetTypeId}}","CollectionId":"{{ev.CollectionId}}","EventId":"{{ev.EventId}}","CommandId":"{{ev.CommandId}}"}
